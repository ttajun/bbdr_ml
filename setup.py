...
setup(
    ...
    url                 = 'https://github.com/ttajun/bbdr_ml',

    # 배포하는 패키지의 다운로드 url을 적어줍니다.
    download_url        = 'https://github.com/ttajun/bbdr_ml',

    # 해당 패키지를 사용하기 위해 필요한 패키지를 적어줍니다. ex. install_requires= ['numpy', 'django']
    # 여기에 적어준 패키지는 현재 패키지를 install할때 함께 install됩니다.
    install_requires    =  ['tensorflow', 'keras', 'numpy', 'pandas', 'matplotlib'],
    ...
    entry_points={
        'console_scripts': [
            'bbdr_mmaker=bbdr_ml.bbdr_mmaker:main',
            'bbdr_predict=bbdr_ml.bbdr_predict:main',
        ],
    },
    # scripts=[''],
